...
console.log(pace);
console.log(pace.demo('classes'));
console.log(pace.grade({name: 'Rika'}, 'Classes'));
...
const pm = new ProjectManager({name: "Pace", age: 34, location: "I don't know", specialty: "Unit 1", favLanguage: "Javascript", catchPhrase:"???", gradClassName:"CS1", favInstructor:"Sean"})
console.log(pm);
console.log(pm.standUp('help_channel'));
console.log(pm.debugsCode({name: 'Rika'}, 'Classes'));
/*
